<?php
	...
	*/
	...
	function htmlUserBar(){
		...
		?>
		<nav class="navbar navbar-default navbar-fixed-top hidden-print d-block" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i>پیشخوان</a>
			</div>

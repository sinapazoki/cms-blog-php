<?php
	...
	//pageEditGroup.php
	$Translation["group exists error"] = "خطا: نام گروه قبلاً موجود است. باید یک نام گروه منحصر به فرد انتخاب کنید.";
	$Translation["group not found error"] = "خطا: گروه یافت نشد!";
	$Translation["edit group"] = "ویرایش گروه '<GROUPNAME>'";
	$Translation["add new group"] = "افزودن گروه جدید";
	$Translation["anonymous group attention"] = "توجه! این گروه ناشناس است.";
	$Translation["show tool tips"] = "نمایش راهنمای ابزار هنگام حرکت ماوس بر روی گزینه‌ها";
	$Translation["group name"] = "نام گروه";
	$Translation["readonly group name"] = "نام گروه ناشناس در اینجا فقط قابل خواندن است.";
	$Translation["anonymous group name"] = "اگر گروه را '<ANONYMOUSGROUP>' نامگذاری کنید، آن را گروه ناشناس در نظر خواهد گرفت<br>که مجوزهای بازدیدکنندگان مهمانی که به سیستم وارد نشده‌اند را تعیین می‌کند.";
	$Translation["description"] = "توضیحات";
	$Translation["allow visitors sign up"] = 'امکان ثبت‌نام بازدیدکنندگان؟';
	$Translation["admin add users"] = "خیر. تنها مدیر می‌تواند کاربران را اضافه کند.";
	$Translation["admin approve users"] = "بله، و مدیر باید آنها را تأیید کند.";
	$Translation["automatically approve users"] = "بله، و به طور خودکار تأییدشوند.";
	$Translation["group table permissions"] = "مجوزهای جدول برای این گروه";
	$Translation["no"] = "خیر";
	$Translation["owner"] = "مالک";
	$Translation["group"] = "گروه";
	$Translation["all"] = "همه";
	$Translation["insert"] = "درج";
	...
	//pageEditMember.php
	$Translation["username error"] = "خطا: نام کاربری قبلاً موجود است یا معتبر نیست. مطمئن شوید که نام کاربری حاوی ۴ تا ۲۰ کاراکتر معتبر باشد.";
	$Translation["member not found"] = "خطا: کاربر یافت نشد!";
	$Translation["user has special permissions"] = "این کاربر دسترسی‌های خاصی دارد که از مجوزهای گروه خود متفاوت است.";
	$Translation["user has group permissions"] = 'این کاربر <a href="pageEditGroup.php?groupID=<GROUPID>">مجوزهای گروه خود را به ارث می‌برد</a>.';
	$Translation["set user special permissions"] = 'مجوزهای خاص را برای این کاربر تنظیم کنید';
	$Translation["sure continue"] = "اگر تغییراتی در این کاربر ایجاد کرده و هنوز آنها را ذخیره نکرده‌اید، اگر ادامه دهید، تغییرات از بین خواهند رفت. آیا مطمئن هستید که می‌خواهید ادامه دهید؟";
	$Translation["edit member"] = "ویرایش کاربر <MEMBERID>";
	$Translation["add new member"] = "افزودن کاربر جدید";
	$Translation["anonymous guest member"] = "توجه! این عضو مهمان ناشناس است.";
	$Translation["admin member"] = 'توجه! این کاربر مدیر است. نام کاربری، رمز عبور و ایمیل این کاربر را در اینجا نمی‌توانید تغییر دهید، اما می‌توانید آنها را در <a href="pageSettings.php">تنظیمات مدیر</a> تغییر دهید.';
	$Translation["member username"] = "نام کاربری کاربر";
	$Translation["check availability"] = "بررسی قابلیت استفاده";
	$Translation["read only username"] = "نام کاربری عضو مهمان فقط خواندنی است.";
	...
	$Translation["member permissions saved"] = "مجوزهای کاربر با موفقیت ذخیره شدند.";
	$Translation["member permissions reset"] = "مجوزهای کاربر به همان مجوزهای گروهش بازگشت داده شدند.";
	$Translation["user table permissions"] = "مجوزهای جدول برای کاربر <a href='pageEditMember.php?memberID=<MEMBER>' title='مشاهده جزئیات کاربر'><MEMBERID></a> از گروه <a href='pageEditGroup.php?groupID=<GROUPID>'  title='مشاهده جزئیات و مجوزهای گروه'><GROUP></a>";
	$Translation["no member permissions"] = 'این کاربر در حال حاضر هیچ مجوز خاصی ندارد. این لیست مجوزهای گروهش را نشان می‌دهد.';
	$Translation["reset member permissions"] = "بازنشانی مجوزهای کاربر";
	$Translation["remove special permissions"] = 'این عمل باعث حذف تمام مجوزهای خاص این کاربر می‌شود و او دسترسی‌هایی مشابه گروهش خواهد داشت. آیا مطمئن هستید که می‌خواهید این کار را انجام دهید؟';
	
	//pageEditOwnership.php
	$Translation["invalid table"] = "جدول نامعتبر است.";
	$Translation["invalid primary key"] = "مقدار کلید اصلی نامعتبر است";
	$Translation["record not found"] = "رکورد پیدا نشد ... اگر این رکورد به صورت خارجی وارد شده است، از منطقه مدیریت برای اختصاص یک مالک استفاده کنید.";
	$Translation["invalid username"] = "نام کاربری نامعتبر است";
	$Translation["record not found error"] = "خطا: رکورد پیدا نشد!";
	$Translation["edit Record Ownership"] = "ویرایش مالکیت رکورد";
	$Translation["owner group"] = "گروه مالک";
	$Translation["view all records by group"] = "مشاهده تمام رکوردها توسط این گروه";
	$Translation["owner member"] = "عضو مالک";
	$Translation["view all records by member"] = "مشاهده تمام رکوردها توسط این عضو";

	$Translation["switch record ownership"] = "تغییر مالکیت رکورد";
	$Translation["record created on"] = "رکورد ایجاد شده در";
	$Translation["record modified on"] = "رکورد ویرایش شده در";
